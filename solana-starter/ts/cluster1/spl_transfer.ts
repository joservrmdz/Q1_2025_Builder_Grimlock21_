...
// Recipient address
const to = new PublicKey("5QJUk3gsGdCB4QJzhW3ecJhePqvX2QZfdba1vNHMmQtr");
...
(async () => {
    try {
        ...
        const tx = await transfer(connection, keypair,fromWallet.address, toWallet.address, keypair, 10 );
